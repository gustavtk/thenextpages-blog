...
/**
 * Enhanced SSG-compatible MiddleAd component with robust collapse functionality
 * Features:
 ...
 * - Designed for seamless injection into article content
...
function MiddleAdContent() {
  const { adRef, adState, retryAd } = useAdSenseWithCollapse({
    ...
    collapseEmpty: true,
    timeoutMs: 10000, // Longer timeout for middle ads as they may load later
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto" style={{ maxWidth: '100%', boxSizing: 'border-box' }}>
        ...
        {/* Advertisement label before the ad for transparency */}
...
/**
 * Main MiddleAd component with SSG-compatible client-only wrapper
 */
export default function MiddleAd() {
  // Provide a fallback skeleton during SSR and initial hydration
  const fallback = (
    <div className="w-full my-6 px-4 sm:px-6 lg:px-8" role="complementary" aria-label="Advertisement loading">
